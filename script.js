...
function takeCommand(message){
    ...
    if(message.includes("hello")||message.includes("hey")){
        ...
        speak("I am virtual assistant,created my Ishika Raj ")
        ...
        speak("your name is Ishika Raj ")
    }else{
        let finalText="this is what i found on internet regarding"+message.replace("orbit","")
        speak(finalText)
        window.open(`https://www.google.com/search?q=${message.replace("Orbit","")}`)
    }
